...
import { Home, User, Settings, Cpu, BookOpen } from 'lucide-react'

const navItems = [
  { to: '/', icon: Home, label: 'Učiť sa', exact: true },
  { to: '/diagrams', icon: Cpu, label: 'Schémy', exact: false },
  { to: '/symbols', icon: BookOpen, label: 'Značky', exact: false },
